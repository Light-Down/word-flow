...
<head>
  ...
  <title>Privacy Policy — Wordflow</title>  <!-- Preload critical fonts -->
    ...
    <div class="space-y-6 text-on-surface-variant leading-relaxed">
      ...
      <section>
        ...
        <p class="mt-3 bg-surface-container rounded-xl p-5 text-sm">
          ...
          <a href="mailto:contact@word-flow.store" class="text-primary hover:underline">contact@word-flow.store</a>
        </p>
      </section>
      ...
      <section>
        ...
        <p class="mt-4">To exercise any of these rights, email us at <a href="mailto:contact@word-flow.store" class="text-primary hover:underline">contact@word-flow.store</a>. We will respond within 30 days.</p>
